...

{
 ...
 address[] public addresses ;  
    ...
    mapping(bytes32=>bytes32) myidList;
      ...
      uint256 token_profits;
      
      uint256 holder_balance;
    ...
    mapping (bytes32 => bytes32)userqueryID;
      ...
      bytes32 ID = oraclize_query("URL","json(https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=EUR).EUR");
        ...
        token_profits = (ether_profit)*(10000000000)/(totalSupply);
        
        Message(ether_profit);
        
         Message(token_profits);
      ...
      function request_dividend(address token_holder) payable
    {
        ...
        holder_balance = balanceOf(token_holder)/10000000000;
        
        Message(holder_balance);
        
        holder_profit = holder_balance * token_profits;
